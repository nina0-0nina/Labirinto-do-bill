...
class GridWorld(tk.Tk):
    ...
    def make_decision(self):
        ...
        direction = self.decision_callback(self.grid, up, down, left, right)
...
def example_callback(grid, up, down, left, right):
    directions = ["up", "down", "left", "right"]
    distances = {"up": up, "down": down, "left": left, "right": right}
    print(distances)
    while True:
        valid_directions = [direction for direction in directions if distances[direction] is not None]
